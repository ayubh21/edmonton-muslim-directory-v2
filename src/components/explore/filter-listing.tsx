    ...
    return (
      <>
        <div className="flex gap-2">
          <section className="  p-4  flex-none min-w-[550px]">
            {isMapView ? (
              <div>
                <MapView
                  positions={getArrOfCoordinates()}
          ...
          <section className="bg-[#f4f4f4]  border-2 p-4  flex-none min-w-[550px]">
            {filteredListings.length > 0 ? (
              <div className=" h-lvh">
                <ListingList
                  listings={filteredListings}
          ...
          <section className=" flex-auto overflow-hidden h-screen">
            <MapView
              positions={getArrOfCoordinates()}
              filteredListings={filteredListings}
            />
