...
export default function Home() {
	...
	if (!isMounted) {
		return (
			<div>
				<LoadingComponent isLoading={isMounted} setIsLoading={setIsMounted} />
			</div>
		)
	}
					...
					<div className="">
						...
						<div className="bg-white p-4 rounded-xl shadow-lg">
							<div className="flex flex-col md:flex-row md:items-center gap-4">
								<div className="flex-1 relative shadow-none">
									<Search className="absolute left-3 top-3 h-5 w-5 text-gray-400 shadow-none" />
									<Input
										type="search"
										placeholder="Search for businesses..."
										className="pl-10 h-12 border-0 focus-visible:ring-0 focus-visible:ring-offset-0 shadow-none text-black"
									/>
								</div>
								<Separator
